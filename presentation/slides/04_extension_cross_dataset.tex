...
\begin{frame}{CP-Decomposition: Efficiency}
    \begin{center}
        \begin{table}
            ...
            \begin{tabular}{lcccc}
                ...
                \midrule
                Vision (Section 4) & 101 & 1.66 & 1.11 & 0.040 \\
                Language (Section 5) & 3 & 19.09 & 0.00 & 0.105 \\
    ...
    \begin{itemize}
        ...
        \item Average GPU-h per run: CP (0.00046) vs Vision$^*$ (0.014) --- \textbf{30$\times$ more efficient}
        \item Only \textbf{3.7 pp accuracy drop} for significant parameter efficiency
    \end{itemize}
    \vspace{0.2cm}
    \footnotesize{$^*$Based on 81 GPU-tracked vision experiments (excluding challenge task)}
\end{frame}
