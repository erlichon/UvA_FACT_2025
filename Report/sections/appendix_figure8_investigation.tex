...
\begin{figure}[H]
    ...
    Scatter plots (right) show rank-2 approximation quality ($r = 0.93$).}
...
\textbf{Empirical validation} on test sentences:
\begin{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        AND-score & Weak & 0.96 \\
        Top eigenvalue $\lambda_1$ & Diffuse & $-0.46$ \\
        Second eigenvalue $\lambda_2$ & Diffuse & $+0.18$ \\
        Eigenvalue ratio $|\lambda_1/\lambda_2|$ & Low & 2.6 \\
        Cluster separation & Diffuse & Clear (3 pos, 12 neg) \\
