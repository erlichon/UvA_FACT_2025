...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/extension_cross_dataset/extension_cross_dataset_3way_comparison_0_O_X.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm]{figures/extension_cross_dataset/extension_cross_dataset_quadratic_form_heatmap_digits.pdf}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[height=4.5cm]{figures/extension_cross_dataset/extension_cross_dataset_heatmap_quadratic_form.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/extension_cross_dataset/extension_cross_dataset_similarity_vs_k_quadratic_form.pdf}
