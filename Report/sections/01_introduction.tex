...
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=2pt]
    ...
    \item \textbf{Extension 2 (Section~\ref{sec:cp_extension}):} We explore CP-decomposition as an architectural constraint for intrinsic low-rank structure, achieving 93.8\% accuracy with disentangled, atomic feature representations.
\end{itemize}
