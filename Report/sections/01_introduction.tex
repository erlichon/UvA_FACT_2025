...
\begin{itemize}
    ...
    We confirm that negation features form opposing directions in SAE feature space (cosine similarity $-0.16$), but do \emph{not} reproduce the low-rank interaction structure---mean rank-2 correlations (0.37--0.55) fall well below the paper's claimed 69\% above 0.75.
