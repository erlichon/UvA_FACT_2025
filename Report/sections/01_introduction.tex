...
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=2pt]
    ...
    \item \textbf{Language Reproduction (Section~\ref{sec:language_results}):} Partially reproduced. We confirm AND-gate negation circuits with semantic opposites (not-good vs.\ not-bad), but the fraction of features achieving high ($>$0.75) rank-2 correlation varies by model (32\%--65\%).
