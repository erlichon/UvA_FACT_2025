...
\begin{frame}{Extension 1: Cosine Similarity Limitations}
    \begin{center}
        \begin{figure}
            \centering
            \includegraphics[width=0.85\textwidth]{../Report/figures/extension2/extension2_heatmap_abs_cosine_similarity.pdf}
...
\begin{frame}{Extension 1: Key Figures}
    \begin{center}
        \begin{figure}
            \centering
            \includegraphics[width=0.85\textwidth]{../Report/figures/extension2/extension2_similarity_vs_k_quadratic_form.pdf}
