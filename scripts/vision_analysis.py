#!/usr/bin/env python3
"""
Unified vision analysis & figure generation (Paper Section 4 + appendix items).
...
def generate_truncation_similarity_section(d: Dirs) -> None:
    ...
    from src.analysis.truncation import (
...
def generate_appendix_adversarial_encoders(d: Dirs, device: str = "cpu") -> None:
    ...
    from matplotlib.gridspec import GridSpec
    from src.analysis.adversarial import compute_adversarial_mask
...
def main() -> int:
    ...
    if "hub" in sections:
        print("\n=== Hub ===")
        print("PaperHub is now generated by: python scripts/paper_hub.py")
